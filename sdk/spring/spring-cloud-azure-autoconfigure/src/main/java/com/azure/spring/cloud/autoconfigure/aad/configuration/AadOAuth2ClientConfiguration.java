...
public class AadOAuth2ClientConfiguration {
     ...
     * Declare ClientRegistrationRepository bean.
     *
     * @param repository the ClientRegistrationRepository bean
     * @return ClientRegistrationRepository bean
     */
    @Bean
    @ConditionalOnMissingBean
    public ReactiveClientRegistrationRepository reactiveClientRegistrationRepository(AadClientRegistrationRepository repository) {
        return new AadReactiveClientRegistrationRepository(repository);
    }
